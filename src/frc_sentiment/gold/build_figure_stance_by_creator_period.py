"""Build gold figure stance metrics by creator/author and publication period."""
...
def main() -> None:
    """Build the gold figure stance by creator/author period table."""
    args = parse_args()
    spark = SparkSession.builder.getOrCreate()

    gold_table = build_figure_stance_by_creator_period(
        spark=spark,
    ...
    write_delta_table(
        gold_table,
        table_name(args.catalog, args.schema, "gold_figure_stance_by_creator_period"),
    )
